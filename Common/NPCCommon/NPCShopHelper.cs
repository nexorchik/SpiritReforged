...
/// <summary>
/// Stores all non-specific NPCShop modifications for ease of use and organization.
/// </summary>
internal class NPCShopHelper : GlobalNPC
{
	...
	/// <summary>
	/// Adds the given entry to the database. This should only be run in <see cref="ModType.SetStaticDefaults"/>.
	/// </summary>

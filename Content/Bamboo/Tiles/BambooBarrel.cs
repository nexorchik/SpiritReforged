...
public class BambooBarrel : ModTile
{
	...
	public override void SetStaticDefaults()
	{
		...
		AddMapEntry(new Color(100, 100, 60), Language.GetText("LegacyChestType.5"), MapChestName);
	...
	private static string MapChestName(string name, int i, int j)
	{
		...
		if (chest < 0)
			return Language.GetTextValue("LegacyChestType.5");
...
public class BambooBarrelItem : ModItem
{
	...
	{
		Item.DefaultToPlaceableTile(ModContent.TileType<BambooBarrel>());
		Item.width = 24;
		Item.height = 18;
		Item.value = 50;
	}
	...
	public override void AddRecipes()
	{
		...
		recipe.AddIngredient(ModContent.ItemType<Items.StrippedBamboo>(), 9);

...
class PlatinumClubProj : BaseClubProj, ITrailProjectile
{
	...
	public override float WindupTimeRatio => 1.7f;
	...
	public void DoTrailCreation(TrailManager tM)
	{
		...
		if (FullCharge)
			tM.CreateCustomTrail(new SwingTrail(Projectile, Color.Silver, 2, AngleRange * 1.1f, HoldAngle_Final, 1.2f * trailDist, trailWidth * 1.2f, GetSwingProgressStatic, SwingTrail.BasicSwingShaderParams));
	}

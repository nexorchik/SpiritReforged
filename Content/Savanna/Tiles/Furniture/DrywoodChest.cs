...
public class DrywoodChest : ModTile, IAutoloadTileItem
{
	private static LocalizedText MapEntry => Language.GetText("Mods.SpiritReforged.Items.DrywoodChestItem.DisplayName");

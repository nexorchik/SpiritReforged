...
using SpiritReforged.Content.Ocean.NPCs;
...
public class HydrothermalVent1x3 : ModTile
{
	...
	public override void NearbyEffects(int i, int j, bool closer)
	{
		...
		if (config.VentCritters)
			...
			{
				HydrothermalVent1x2.SpawnCritter<TinyCrab>(i, j, 500);
				HydrothermalVent1x2.SpawnCritter<Crinoid>(i, j, 110);
				HydrothermalVent1x2.SpawnCritter<TubeWorm>(i, j, 425);
			}
	}
}

...
public class Magmastone : ModTile, IAutoloadTileItem
{
	...
	public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
	{
		...
		var color = Lighting.GetColor(i, j) * 3;

		spriteBatch.Draw(glowTexture.Value, new Vector2(i * 16, j * 16) - Main.screenPosition + zero, new Rectangle(t.TileFrameX, t.TileFrameY, 16, 16), color);
	}
}
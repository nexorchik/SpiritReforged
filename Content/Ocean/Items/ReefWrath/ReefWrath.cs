...
public class ReefWrath : ModItem
{
	public override void SetDefaults()
	{
		...
		Item.shoot = ModContent.ProjectileType<ReefWrathProj_Alt>();
		Item.shootSpeed = 0f;
		Item.knockBack = 8;
	...
	public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback) 
	{
		for (int i = 0; i < 3; i++)
		{
			...
			Projectile.NewProjectile(source, pos, vel, Item.shoot, damage, knockback, player.whoAmI);
		}

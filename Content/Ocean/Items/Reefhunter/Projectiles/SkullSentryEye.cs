...
public class SkullSentryEye : ModProjectile
{
	...
	public override void AI()
	{
		...
		float distMod = EaseFunction.EaseQuadOut.Ease(Math.Min(Timer / 480, 1)); //Ease worm distance from skull out over a few seconds
		...
		else
		{
			...
			{
				var shot = Projectile.NewProjectileDirect(Projectile.GetSource_FromAI(), Projectile.Center, vel, ModContent.ProjectileType<SkullSentryMucus>(), Projectile.damage, 10.2f, Projectile.owner);
